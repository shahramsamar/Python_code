...
class Bingo:
    ...
    def __str__(self):
        return f"{self.name}: {'won' if self.won else 'player is gameOver'} , Rounds: {self.current_round} AS {self.guess_round}"
    ...
    def play(self):
        while True:
            ...
            for player in self.players:
                if player.won or player.check_gameOver():
                    continue
                ...
                if player.check_gameOver() and not player.won:
